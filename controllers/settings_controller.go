...
type UpdateSettingsRequest struct {
	...
	RequireReceiptReview *bool  `json:"require_receipt_review"`
}
...
func (c *SettingsController) GetSettingsHTTP(ctx *gin.Context) {
	...
	ctx.JSON(http.StatusOK, gin.H{
		...
		"require_receipt_review": currentUser.RequireReceiptReview,
	})
}
...
func (c *SettingsController) SaveSettingsHTTP(ctx *gin.Context) {
	...
	if req.RequireReceiptReview != nil {
		currentUser.RequireReceiptReview = *req.RequireReceiptReview
	}
